...
class Board:
    ...
    def print_thingy(self):
        for i in range(3):
            for j in range(3):
                ...
                self.print_stuff(100, str(n), BLACK, xx, yy)
    ...
    def check_winner(self, turn):
        ...
        if Board.winner != None:
            ...
            self.print_stuff(110, "Won!", RED, (DISPLAY_WIDTH//2)-100, (DISPLAY_WIDTH//2)-30)
        ...
        if not Board.winner:
            if empty == [True]*3:
                self.print_stuff(110, "Tie!", RED, (DISPLAY_WIDTH//2)-70, (DISPLAY_WIDTH//2)-30)
# The Main Function
def main():
    while True:
